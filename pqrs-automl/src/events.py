...
src/events.py
-------------
Gestión de eventos institucionales con vigencia.
Los eventos activos se inyectan como contexto en las respuestas de la API.

Tipos de vigencia:
  - horas: el evento expira N horas después de su creación
  - dias:  el evento expira N días después de su creación
"""
...
def create_event(
    ...
    descripcion: str,
    vigencia_valor: int,
    vigencia_tipo: str,   # "horas" o "dias"
    area: str = "General",
) -> dict:
